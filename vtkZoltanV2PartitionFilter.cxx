...
struct vtkZoltan2Helper
{
            ...
            vtkZoltanV2PartitionFilter *self)
    {
        ...
        if (weightarray==NULL) {
            ...
            InputAdapter = new inputAdapter_t(localCount, globalIds, x, y, z, 3, 3, 3);
    ...
    switch(coordArray->GetDataType())
    {
      vtkZoltanTemplateMacro(
              vtkZoltan2Helper<VTK_TT>::SolveZoltan2Partition(
                      coordArray, localCount, globalIds, static_cast<VTK_TT*>(weights_data_ptr), this));
    }
