...
FILE_PREFIX=$(printf '%d' ${RESOLUTION})
...
aprun -n ${TASKS} -N ${NPERNODE} /scratch/daint/biddisco/egpgv/pvbatch --use-offscreen-rendering --disable-xdisplay-test /scratch/daint/biddisco/egpgv/scripts/benchmark-wavelet-UG.py -r $RESOLUTION -f $FILTER > timing-log.txt
